...
public class SendUDIDAsyncTask extends AsyncTask<String, Void, String> {

	private Activity activity;
	private ProgressDialog progressDialog;
	private OnRequestComplete callback;

	public SendUDIDAsyncTask (Activity activity, OnRequestComplete callback2) {
	...
	protected String doInBackground(String... params) {
		...
		try {
			return CommunicationLayer.getEnterUDId(params[0], params[1], params[2], params[3]);
		} catch (Exception ex) {
			ex.printStackTrace();
		}
